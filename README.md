...
[![Build Status](https://travis-ci.org/mihaigalos/miniboot.svg?branch=master)](https://travis-ci.org/mihaigalos/miniboot) [![license](https://img.shields.io/badge/license-GPLv3-brightgreen.svg)](LICENSE) [![HitCount](http://hits.dwyl.com/mihaigalos/miniboot.svg)](http://hits.dwyl.com/mihaigalos/miniboot) [![LoC](https://tokei.rs/b1/github/mihaigalos/miniboot)](https://github.com/Aaronepower/tokei)
...
Miniboot depends on [avr-bootloader-common](https://github.com/mihaigalos/avr-bootloader-common/) for commonalities between bootloaders, [I2C-master-lib](https://github.com/g4lvanix/I2C-master-lib/) for I2C communication and [Drivers](https://github.com/mihaigalos/Drivers/) for CRC32 computation and EEPROM access.
...
- put the value in the BOOTLOADER_START_ADDRESS macro in the Makefile or manually edit bootloader.h
